// src/modules/polymarket/services/fetchers/index.ts

export { eventFetcher, EventFetcher } from './event.fetcher';
export { marketFetcher, MarketFetcher } from './market.fetcher';
